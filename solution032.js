function findEvenIndex(arr) {
    ...
    //   P - for loop iterating over each index in the array, nest within two map calls, one for integers before current index and one after. Then compare accumulators, if equal return current index, otherwise continue to next index.
